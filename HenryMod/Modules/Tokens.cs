...
namespace RocketSurvivor.Modules
{
    internal static class Tokens
    {
        internal static void AddTokens()
        {
            ...
            LanguageAPI.Add(prefix + "PRIMARY_DESCRIPTION", "<style=cIsUtility>Agile</style>. Fire a rocket for <style=cIsDamage>570% damage</style>. Can hold up to 4.");

            //Unlock Condition: Hit 20 airshots.
            LanguageAPI.Add(prefix + "PRIMARY_ALT_NAME", "HG4 SAM Launcher");
            LanguageAPI.Add(prefix + "PRIMARY_ALT_DESCRIPTION", "<style=cIsUtility>Agile</style>. Fire a heat-seeking precision rocket for <style=cIsDamage>570% damage</style>. Deals <style=cIsDamage>+30% damage</style> against <style=cIsUtility>airborne targets</style>. Can hold up to 4.");
            ...
            LanguageAPI.Add(prefix + "SPECIAL_CLUSTER_DESCRIPTION", "Fire a cluster missile that repeatedly explodes for <style=cIsDamage>10x160% damage</style>.");

            LanguageAPI.Add(prefix + "SPECIAL_CLUSTER_SCEPTER_NAME", "Cluster Strike");
            LanguageAPI.Add(prefix + "SPECIAL_CLUSTER_SCEPTER_DESCRIPTION", "Fire a cluster missile that repeatedly explodes for <style=cIsDamage>16x200% damage</style>.");
        }
    }
}