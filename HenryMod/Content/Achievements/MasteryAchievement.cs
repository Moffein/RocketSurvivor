...
namespace HenryMod.Modules.Achievements
{
    ...
    {
        public override string AchievementTokenPrefix => RocketSurvivorPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_MASTERY";
        ...
        public override string PrerequisiteUnlockableIdentifier => RocketSurvivorPlugin.DEVELOPER_PREFIX + "_HENRY_BODY_UNLOCKABLE_REWARD_ID";
